...
import slp.core.counting.beta.visitor.BetaCounterVisitor;
import slp.core.util.Configuration;

import java.util.Set;

@Deprecated // Kept for reference
public class BetaCounterMapOld extends BetaCounter {
	...
	public Map<Integer, BetaCounter> getSuccessors() {
	...
	private BetaCounter promoteArrToMap(Integer key, BetaCounterArray curr) {
		BetaCounterMapOld newNext = new BetaCounterMapOld();
	...
	@Override
	public void visit(BetaCounterVisitor visitor) {
		// Visit me
		visitor.visit(this);
		// Visit nexts
		for (BetaCounter successor : this.successors.values()) {
			successor.visit(visitor);
		}
	}
	...
	private void readSuccessors(ObjectInput in) throws IOException, ClassNotFoundException {
		...
		for (int i = 0; i < size; i++) {
			...
			BetaCounter counter;
			switch (type) {
				case 0: counter = new BetaCounterMapOld(); break;
				...
				default: counter = new BetaCounterMapOld();
			}
